...
mkdir   ~/Genomes_mol_typing/Chlamydiales/GATK4/mapped/Italy_bowtie2
mkdir ~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2
mkdir ~/Genomes_mol_typing/Chlamydiales/GATK4/analysis/Italy_bowtie2

cd ~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2
...
for read1 in ~/Genomes_mol_typing/Chlamydiales/SRA/Italy/*_1.fastq.gz # for each sample
  do
    ...
    read1=~/Genomes_mol_typing/Chlamydiales/SRA/Italy/${base}_1.fastq.gz
    read2=~/Genomes_mol_typing/Chlamydiales/SRA/Italy/${base}_2.fastq.gz
    bowtie2_index=~/Genomes_mol_typing/Chlamydiales/reference/Chl.trach_bowtie2_index
    sam=~/Genomes_mol_typing/Chlamydiales/GATK4/mapped/Italy_bowtie2/${base}.sam
    bam=~/Genomes_mol_typing/Chlamydiales/GATK4/mapped/Italy_bowtie2/${base}.bam
    sorted_bam=~/Genomes_mol_typing/Chlamydiales/GATK4/mapped/Italy_bowtie2/${base}.sorted.bam
    rgs_bam=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/bam/${base}.rgs.bam
    rgs_sorted_bam=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/bam/${base}.rgs.sorted.bam
    marked_dup_bam=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/bam/${base}.marked_dup.bam
    dup_metrics=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/bam/${base}.dup_metrics.txt
    variants=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/vcf/${base}.vcf
    variants_filtered=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/vcf/${base}.filtered.vcf
    variants_passed=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/Italy_bowtie2/vcf/${base}.passed.vcf
    snp_vcf=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/test/Italy_bowtie2/${base}.snp.vcf
    indel_vcf=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/test/Italy_bowtie2/${base}.indel.vcf
    snp_named_vcf=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/test/Italy_bowtie2/${base}.snp.named.vcf
    indel_named_vcf=~/Genomes_mol_typing/Chlamydiales/GATK4/calling/test/Italy_bowtie2/${base}.indel.named.vcf
    annovar_db=~/Genomes_mol_typing/Chlamydiales/cpdb/

bowtie2 -p 8 -x $bowtie2_index  -1 $read1  -2 $read2 -S $sam
